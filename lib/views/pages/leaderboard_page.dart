            ...
            return Scaffold(
              ...
              body: RefreshIndicator(
                onRefresh: () {
                  ...
                  MyApp.leaderboardBloc
                      .add(InitializeLeaderboardData(completer: completer));
                      ...
                      sliver: SliverList.builder(
                        itemBuilder: (context, index) {
                          final Leaderboard leaderboard =
                              stateLeaderboard.leaderboards[index];
                          return Column(
                            children: [
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    switch (index) {
                                      0 => SvgPicture.asset(
                                          'assets/svgs/bi trophy 1.svg'),
                                      1 => SvgPicture.asset(
                                          'assets/svgs/bi trophy 2.svg'),
                                      2 => SvgPicture.asset(
                                          'assets/svgs/bi trophy 3.svg'),
                                      _ => Container(
                                          width: 24.0,
                                          height: 24.0,
